...
class GetJwksParams(object):
    ...
    def op_configuration_endpoint(self):
        """Gets the op_configuration_endpoint of this GetJwksParams.  # noqa: E501

        The openid configuration endpoint URL. If missing, then `op_host` must be defined.  # noqa: E501

        :return: The op_configuration_endpoint of this GetJwksParams.  # noqa: E501
        :rtype: str
        """
    ...
    def op_configuration_endpoint(self, op_configuration_endpoint):
        """Sets the op_configuration_endpoint of this GetJwksParams.

        The openid configuration endpoint URL. If missing, then `op_host` must be defined.  # noqa: E501

        :param op_configuration_endpoint: The op_configuration_endpoint of this GetJwksParams.  # noqa: E501
        :type: str
        """
