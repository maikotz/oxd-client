...
class GetClientTokenParams(object):
    ...
    def __init__(self, op_configuration_endpoint=None, op_host=None, op_discovery_path=None, scope=None, client_id=None, client_secret=None, authentication_method=None, algorithm=None, key_id=None):  # noqa: E501
    ...
    def op_configuration_endpoint(self):
        """Gets the op_configuration_endpoint of this GetClientTokenParams.  # noqa: E501

        The openid configuration endpoint URL. If missing, then `op_host` must be defined.  # noqa: E501

        :return: The op_configuration_endpoint of this GetClientTokenParams.  # noqa: E501
        :rtype: str
        """
    ...
    def op_configuration_endpoint(self, op_configuration_endpoint):
        """Sets the op_configuration_endpoint of this GetClientTokenParams.

        The openid configuration endpoint URL. If missing, then `op_host` must be defined.  # noqa: E501

        :param op_configuration_endpoint: The op_configuration_endpoint of this GetClientTokenParams.  # noqa: E501
        :type: str
        """
