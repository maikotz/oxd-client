...
**op_configuration_endpoint** | **str** | The openid configuration endpoint URL. If missing, then either it must be present in defaults or &#x60;op_host&#x60; must be defined. | [optional] 
